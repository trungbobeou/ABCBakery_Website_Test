...
<body>
    ...
    <?php include 'pages/slider.html';?>
    <!-- slider  section end  -->

    <!-- featured section starts  -->
    <?php include 'pages/featured.html';?>
    ...
    <?php include 'pages/gallery.html';?>
    ...
    <?php include 'pages/testimonial.html';?>
    <!-- testimonial section ends -->

    <!-- staff section --- chef starts -->
    <?php include 'pages/staff.html';?>
    <!-- staff section --- chef ends -->

    <!-- order a cake section starts -->
    <?php include 'pages/order.html';?>
    <!-- order a cake section ends -->

    <!-- blog section starts -->
    <?php include 'pages/blog.html';?>
    <!-- blog section ends -->
